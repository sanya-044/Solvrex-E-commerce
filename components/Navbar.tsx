      ...
      <header className="sticky top-0 z-50 border-b border-black/10 bg-[#f5f3ee]/95 backdrop-blur-md">
        ...
        <div className="relative mx-auto flex h-[72px] max-w-[1600px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <button
            ...
            className="-m-2.5 flex items-center justify-center p-2.5 lg:hidden"
            aria-label="Menu"
          >
            {menuOpen ? (
              <X
  ...
  <>
    {session?.user ? (
      <Link
        href="/account"
        aria-label="Account"
        className="-m-2.5 flex items-center gap-2 p-2.5 transition-opacity hover:opacity-50"
      >
        <UserRound
          size={20}
          strokeWidth={1.4}
        ...
        <span className="hidden xl:block text-[9px] font-bold uppercase tracking-[0.16em]">
          Login
            ...
            <Link
              href="/wishlist"
              aria-label="Wishlist"
              className="relative -m-2.5 hidden p-2.5 sm:block"
            >
              <Heart
                size={20}
                strokeWidth={1.4}
              ...
              {wishlistCount > 0 && (
                <span className="absolute right-0.5 top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-black px-1 text-[8px] text-white">
                  {wishlistCount}
                </span>
              )}
            </Link>
            ...
            <a
              ...
              className="relative -m-2.5 flex items-center justify-center p-2.5"
            >
              <ShoppingBag
                size={20}
                strokeWidth={1.4}
